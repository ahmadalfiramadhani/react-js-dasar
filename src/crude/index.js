...
// import NavbarComponent from './Navbare';
import Tabel from './Tabele';
import Formulir from './Formulire'
    ...
    qty: this.state.qty
        ...
        console.log(this.state.bukus)
            return(
                ...
                <Formulir {...this.state} handleChange={this.handleChange} handleSubmit={this.handleSubmit} required/>
                </div>
            </div>
        )
    }
